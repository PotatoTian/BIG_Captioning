...
class CiderScorer(object):
    ...
    def __init__(self, test=None, refs=None, n=4, sigma=6.0,coco_df=0):
        ''' singular instance '''
        self.n = n
        self.sigma = sigma
        self.crefs = []
    ...
    def compute_score(self, df_mode, option=None, verbose=0):
        ...
        if df_mode == "corpus":
            ...
            docFreq = self.coco_df#pickle.load(open('../coco-caption/pycoco_cider/'+df_mode + '.p', 'rb'),encoding='latin1')
