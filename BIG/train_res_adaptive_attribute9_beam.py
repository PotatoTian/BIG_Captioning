...
from core.res_solver_adaptive_attribute8_beam import CaptioningSolver
from core.res_model_adaptive_attribute9_beam import CaptionGenerator
...
def main():
    ...
    solver = CaptioningSolver(word_to_idx,model, data, val_data, n_epochs=50, batch_size=128, update_rule='adam',k = 2,length_panelty = 0.1,
                                          learning_rate=5e-4, print_bleu_every= 1000, save_every=1000, image_path='./image/',
                                    pretrained_model='/data1/junjiaot/model/Resnet_Pretrain_adaptive_attribute9/model/1000-41', model_path='model/Resnet_Pretrain_adaptive_attribute9/', test_model='model/lstm/model-5',
