...
from core.res_solver_adaptive_attribute8 import CaptioningSolver
from core.res_model_adaptive_attribute9 import CaptionGenerator
...
def main():
    ...
    solver = CaptioningSolver(model, data, val_data, n_epochs=50, batch_size=56, update_rule='adam',
                                          learning_rate=5e-4, print_bleu_every= 1000, save_every=1000, image_path='./image/',
                                     model_path='model/Resnet_Pretrain_adaptive_attribute9_new/', test_model='model/lstm/model-5',
